    ...
    <div class="box-content">
        ...
        echo '</p></div>';
                ...
                <div class="col-xs-7 pull-right">
                    ...
                    <a class="btn btn-info" href="nfe/xml-nfce.php?pedido=<?php echo $inv->id; ?>" target=_blank>Imprimir NFCe</a>

                    <a class="btn btn-info" href="nfe/xml-nfe.php?pedido=<?php echo $inv->id; ?>" target=_blank>Imprimir NFe</a>


                    <a class="btn btn-success" href="nfe/index.php?pedido=<?php echo $inv->id; ?>">NFe Bling</a>
