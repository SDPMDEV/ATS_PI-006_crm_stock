...
<body class="login-page">
    ...
    ?>
                            ...
                            <div class="div-title col-sm-12">
                                <h3 class="text-warning"><?= lang('login_to_your_account') ?></h3>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="form-action col-sm-12">
                                ...
                                <button type="submit" class="btn btn-warning pull-right"><?= lang('login') ?> &nbsp; <i class="fa fa-sign-in"></i></button>
                            </div>
                            <?php echo form_close(); ?>
                        ...
                        <div class="login-form-links link2">
                            <h4 class="text-danger">Precisa de Suporte Técnico?</h4>
                            <span>Não se preocupe</span>
                            <a href="https://suporte.alliancets.app" target="_blank" class="text-danger">Abra um ticket de suporte.</a>
                            <span>Suporte Alliance Tech System</span>
                        </div>
                        <?php
                ...
                <div class=" container">
                    <div class="login-form-div">
                        <div class="login-content">
                            ...
                            ?>
                            <div class="div-title col-sm-12">
                                <h3 class="text-warning"><?= lang('forgot_password') ?></h3>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-action">
                                    <a class="btn btn-warning pull-left login_link" href="#login">
                ...
                <div id="register">
                    <div class="container">
                        <div class="registration-form-div reg-content">
                            ...
                            <div class="div-title col-sm-12">
                                <h3 class="text-warning"><?= lang('register_account_heading') ?></h3>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-12">
                                <a href="#login" class="btn btn-warning pull-left login_link">
                                    <i class="fa fa-chevron-left"></i> <?= lang('back') ?>
                                </a>
                                <button type="submit" class="btn btn-warning pull-right">
