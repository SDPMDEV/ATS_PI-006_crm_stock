        ...
        <div class="modal-body">
            ...
            <div id="wrapper">
                ...
                <div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
                    ...
                    <button class="btn btn-success btn-block" id="btnCupomFiscal"
                            onclick="$('#cpfNota').modal('toggle')">Cupom Fiscal</button>
            ...
            <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="cpfNota"
                 aria-hidden="true" id="cpfNota">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content" style="padding: 20px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="valor_pago" id="valor_pago" value="<?= $this->sma->formatMoney($payment->pos_paid == 0 ? $payment->amount : $payment->pos_paid) . ($payment->return_id ? ' (' . lang('returned') . ')' : ''); ?>">
            ...
            <script>
                ...
                function emitirCupomFiscal() {
                    if (validaCpf()) {
                        window.open(window.location.origin + '/generate/nfce/?valor_pago='+$("#valor_pago").val()+'&troco='+$("#troco").val()+' &cpf=' + $('#cpf').val());
                    } else {
