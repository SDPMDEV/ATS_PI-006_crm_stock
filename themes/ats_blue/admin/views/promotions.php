...
<head>
    ...
    <title>ATS SMA Promotional</title>
        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">Módulo de PDV para gerenciamento de estoque avançado</h1>
                    <p class="lead">ATS Stock Manager Advance é uma aplicação web baseada em php para pequenas e médias empresas para gerenciar estoques, vendas (com pagamentos online), despesas, clientes e depósitos. </p>
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>ATS Stock Manager Advanced por <a href="https://alliancetechsystem.com">Alliance Tech System</a>.</p>
                    </div>
                </div>
            </div>
        </div>
