...
$lang['pos_setting_updated_payment_failed'] = 'As Configurações do PDV foram gravadas com sucesso, mas as configurações dos gatways de pagamento falhou. Por favor, tente novamente';
...
$lang['paid_l_t_payable']                   = 'O Valor PAGO é menor do que o valor à Pagar.';
...
$lang['sale_details_modal']                 = 'Detalhes da Venda Suspenso';
...
$lang['api_transaction_key']                = 'Chave de transação API';
$lang['toggle_brands_slider']               = 'Alternar controle deslizante de marcas';
$lang['gc_sale']                            = 'Pagamento com cartão-presente';
$lang['sale_status']                        = 'Status da Venda';
$lang['display_customer_details']           = 'Exibir detalhes do cliente no recebimento';
$lang['comment']                            = 'Comentário';
$lang['open_cash_drawer']                   = 'Abra a gaveta de dinheiro';
$lang['pos_printing']                       = 'Impressão POS';
$lang['title']                              = 'Título';
$lang['network']                            = 'Rede';
...
$lang['alert_x_printer']                    = 'Você está deletando a impressora, por favor clique em ok para deletar.';
$lang['receipt_printer']                    = 'Impressora de recibos';
$lang['order_printers']                     = 'Encomendar impressoras';
$lang['bill_note']                          = 'Esta é uma cópia para uso comercial, solicite recibo / fatura com o número de venda. Obrigada';
$lang['extra_details']                      = 'Detalhes Extra';
$lang['sale_no_ref']                        = 'Venda nº/Ref';
$lang['auto_print']                         = 'Recibo de impressão automática';
$lang['receipt_header']                     = 'Cabeçalho de Recibo';
$lang['printing']                           = 'Impressão';
$lang['local_install']                      = 'Servidor PHP (apenas para instalação local)';
$lang['web_browser_print']                  = 'Web Browser';
$lang['pos_print_app']                      = 'Servidor de impressão Node POS';
$lang['php_pos_print_app']                  = 'Servidor de impressão PHP POS (servidor ativo ou local)';
$lang['merchant_copy']                      = 'Cópia do comerciante';
$lang['pos_print_error']                    = 'Incapaz de conectar ao soquete, certifique-se de que o servidor está instalado e funcionando corretamente.';
$lang['printer_port_tip']                   = 'A maioria das impressoras está aberta na porta <strong>9100</strong>';
$lang['print_recommandations']              = 'Para instalação local em uma única máquina: <strong>PHP Server</strong>será a melhor escolha e para servidor ativo ou configuração de servidor local (LAN): você pode instalar <strong>PHP Pos Print Server</strong> locally on each machine (recommended) or use web browser printing feature.';
$lang['printer_path_tip']                   = '<strong>Para Windows:</strong> (USB local, impressora serial ou paralela): compartilhe a impressora e insira o nome de compartilhamento para a sua impressora aqui ou para Server Message Block (SMB): insira como um formato smb: // url, como <code>smb: // nome do computador / impressora de recibos</code><br><strong>Para Linux:</strong> Paralelo como <code>/dev/lp0</code>, USB como <code>/dev/usb/lp1</code>, USB-Serial como <code>/dev/ttyUSB0</code>, Serial como <code>/dev/ttyS0</code><br>';
$lang['old_sale_loaded']                    = 'Dados de venda antigos carregados com sucesso';
$lang['duplicate_sale']                     = 'Duplicar Venda';
$lang['use_local_printers']                 = 'Use a configuração da impressora local (servidor de impressão POS)';
$lang['receipt_from']                       = 'Recibo de';
$lang['register_total_tip']                 = 'Reveja os detalhes abaixo como <strong>pago (total)</strong>';
$lang['desc']                               = 'Descrição';
$lang['qty_x_price']                        = 'Qtd x Preço';
